...
<template>
  <div
    class="bg-main-light-brown font-poppins sticky top-0 z-20 flex h-15 w-full items-center justify-between border-b-2 border-black/15 p-2 px-8 drop-shadow-sm drop-shadow-black/10 sm:h-20 sm:py-4"
  >
    <RouterLink
