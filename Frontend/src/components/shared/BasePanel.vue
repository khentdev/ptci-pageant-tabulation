  ...
  >
    <div class="flex w-full justify-between gap-2">
      ...
      <button
        v-if="addButtonLabel"
        @click="emit('add')"
        class="bg-main-dark-brown border border-white/30 hover:bg-main-dark-brown/80 flex h-10 items-center gap-2 rounded-lg p-4 text-xs text-white sm:h-15 sm:text-base"
      >
