  ...
  <div class="flex h-full w-full flex-col gap-4">
    <div class="flex gap-4">
      <button
        ...
        @click="contestantStore.applyFilter()"
      ...
      <button
        ...
        @click="contestantStore.applyFilter('MALE')"
        class="cursor-pointer border border-black px-6 py-2"
      >
        Male
      </button>
      <button
        ...
        @click="contestantStore.applyFilter('FEMALE')"
        class="cursor-pointer border border-black px-6 py-2"
      >
        Female
      </button>
            ...
            <td class="border">
              <div class="flex h-12 items-center justify-center gap-4">
                <button
                  ...
                  class="h-10 rounded-xl bg-amber-300 px-6 hover:bg-amber-400"
                >
                  Edit
                </button>
                <button
...
const handleDeleteContestant = async (id: number) => {
  ...
  await contestantStore.getContestants();
  contestantStore.applyFilter();
};
