<template>
  <teleport to="body">
    <div
      @click.self="modalStore.judgesModalFunction().toggleResetPasswordJudgesModal()"
    ...
    >
      ...
      >
        <div class="flex w-full items-center justify-between px-4 text-2xl">
          <p>Edit Judge</p>
          <button
            @click="modalStore.judgesModalFunction().toggleResetPasswordJudgesModal()"
