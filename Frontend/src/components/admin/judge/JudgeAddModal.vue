<template>
  ...
  >
    <form @submit.prevent="saveJudge()" class="flex h-full w-full flex-col justify-start gap-4 p-4">
      ...
      <div class="flex flex-col">
        ...
        <input
          ...
          class="h-10 w-full border border-black px-3"
        />
        <div v-if="judgeStore.formErrors.judgeUsername" class="mt-1 flex w-full items-start gap-1">
          <CircleAlert class="shrink-0 stroke-red-500 stroke-2" :size="18" />
          <p class="text-sm text-red-500">
      ...
      <div class="flex flex-col">
        ...
        <input
          ...
          class="h-10 w-full border border-black px-3"
        />
        <div v-if="judgeStore.formErrors.judgePassword" class="mt-1 flex w-full items-start gap-1">
          <CircleAlert class="shrink-0 stroke-red-500 stroke-2" :size="18" />
          <p class="text-sm text-red-500">
